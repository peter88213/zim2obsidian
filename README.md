...
### Skipping rename for directories

Pages generated by Zim's Journal plugin do not follow the same template, and
their first headers (long form dates) are always different from the file names,
